...
public final class IdGenerator {
    ...
    public static final ShortSnowflakeId SNOWFLAKE_ID = ShortSnowflakeId.INSTANCE;

    public static class ShortSnowflakeId {

        static ShortSnowflakeId INSTANCE = new ShortSnowflakeId(1);
